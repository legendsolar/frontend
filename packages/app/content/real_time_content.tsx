      ...
      >
        <Stack>
          ...
          <Typography variant={"body" as any}>
            Don’t worry, this will not impact your earnings or impact. Live data
            will return once the connection is restored.
          </Typography>
        </Stack>
      </Component>
    );
        ...
        <Grid item xs={12} lg={6}>
          <Stack spacing={4} sx={{ ml: "auto", mr: "auto" }}>
            ...
            <MetricGauge
              ...
              min={0}
              max={
                generationMetaData.max_kW * generationMetaData.dollar_per_kWh
              }
              currentValue={current_kW * generationMetaData.dollar_per_kWh}
              message={message}
              unit={dollars}
            ></MetricGauge>
        ...
        <Grid item xs={12} lg={6}>
          <Stack spacing={4}>
            <MetricGauge
              title="Carbon"
              min={0}
              max={generationMetaData.max_kW * generationMetaData.co2_per_kWh}
              currentValue={current_kW * generationMetaData.co2_per_kWh}
              message={message}
              unit={carbonEnglish}
            ></MetricGauge>
