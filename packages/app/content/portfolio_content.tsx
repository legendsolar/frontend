              ...
              <Stack>
                <Stack direction={"row"} justifyContent={"space-between"}>
                  <Typography variant={"smallHeadline" as any}>
                    {generationMetaData.panel_count + " panels"}
                  </Typography>
                  <Stack alignItems={"flex-end"}>
                    ...
                    >
                      {currencyFormatter(
                        generationTotals.twentyFourHourGeneration_kWh.current *
                  ...
                  valuePairs={[
                    {
                      ...
                      value: numberFormatter(
                        generationMetaData.max_kW * 1000,
                        5
                      ),
                    },
                    {
                      metric: "Cost",
                      value: currencyFormatter(economics.cost_dollars),
                    },
                    {
              ...
              <Grid container>
                <Grid item lg={4} xs={4}>
                  <MetricBox
                    metric={
                      "$" +
                      numberFormatter(earningsTotals.totalEarnings_Dollars, 2)
                    }
        ...
        <SideBarView
          ...
          mainContent={
            <Stack>
                      ...
                      valuePairs={[
                        {
                          ...
                          value: currencyFormatter(
                            nonNullFacility.economics.cost_dollars
                          ),
                        },
                        {
                          metric: "Hold Term",
                          value: nonNullFacility.economics.ppaDuration || "NA",
                        },
                        {
                      ...
                      valuePairs={[
                        {
                          ...
                          value: generationMetaData.panel_count.toFixed(0),
                        },
                        {
                          metric: "Make & model",
                          value:
                            nonNullFacility.generationMetaData.make || "NA",
                        },
                        {
                          metric: "Watts Installed",
                          value:
                            numberFormatter(
                              nonNullFacility.generationMetaData.max_kW * 1000
                            ) || "NA",
                        },
                      ]}
                    />
              ...
              <ContentDivider>
                <Typography variant={"monoButton" as any}>Documents</Typography>
              </ContentDivider>
