...
import { BasicGlobe } from "@project/components/map/basic_globe_component";
        ...
        >
          <BasicGlobe
            ...
            markers={assetMarkerArray.map((asset) => (
              <Marker lng={asset.location.lng} lat={asset.location.lat}>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    ...
                    >
                      {asset === selectedAsset ? asset.title : "☀️"}
                    </Typography>
                  </Component>
                  <div
                    style={{
                ...
                <Stack direction={"row"} alignItems={"center"}>
                  ...
                  <Stack>
                    ...
                    <Typography variant={"monoButton" as any}>
                      {`${currencyFormatter(asset.minInvestment)} | ${
                    ...
                    <Grid item xs={12} lg={4}>
                      <Stack alignItems={"center"}>
                        <Stack direction={"row"}>
                          ...
                          >
                            {numberFormatter(asset.capacity_kW) + "kW"}
                          </Typography>
                        </Stack>
                        <Typography
                          variant={"monoButton" as any}
