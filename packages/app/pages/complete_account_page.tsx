...
const CompleteAccountPage = () => {
          ...
          <CompleteAccountContent
            ...
            steps={[
              ...
              },
              {
                ...
                disabled: !stepsComplete.email || !stepsComplete.information,
                disabledMessage: "Verify email and information first",
                completeMessage: <CheckIcon />,
          ...
          <CreateWalletContent
            onSubmit={async (input) => {
              await createDwollaAccount({
                firstName,
                lastName,
                ...transformFormValuesToUserDwollaAccountData(input),
              });
  ...
  const rightPaneStates = (state: States): JSX.Element => {
    switch (state) {
      ...
      case States.PASSWORD_RESET_REQ:
        return <img src={PanelPersonBlueSVG} style={{ width: "300px" }}></img>;
      case States.INFORMATION:
        return <img src={PanelPersonBlueSVG} style={{ width: "300px" }}></img>;
      case States.EMAIL:
        return <img src={PanelPersonGreenSVG} style={{ width: "300px" }}></img>;
      case States.PHONE:
        return (
          <img src={PanelPersonYellowSVG} style={{ width: "300px" }}></img>
        );
      case States.ACCREDITATION:
        return <img src={PanelPersonPinkSVG} style={{ width: "300px" }}></img>;
      case States.WALLET:
        return <img src={PanelPersonRedSVG} style={{ width: "300px" }}></img>;
    }
  };
  ...
  return (
    <DualPaneView
      leftPane={loading ? <LoadingComponent></LoadingComponent> : states(state)}
