        ...
        <Stack sx={{ p: 4, backgroundColor: "whiteFog.main" }} spacing={4}>
          ...
          >
            ...
            >
              <Button
                sx={{
                  backgroundColor:
                    unitState === dollars ? "white.main" : "whiteHaze.main",
              ...
              <Button
                sx={{
                  backgroundColor:
                    unitState === energy ? "white.main" : "whiteHaze.main",
          ...
          >
            ...
            <Slider
              aria-label="Volume"
              value={panels}
              onChange={(event, newValue) => setPanels(newValue as number)}
              min={1}
              max={10}
              marks={marks}
        ...
        <Stack sx={{ p: 4, backgroundColor: "whiteFog.main" }} spacing={4}>
          ...
          >
            ...
            <Button
              sx={{
                backgroundColor:
                  unitState === carbonEnglish ? "white.main" : "whiteHaze.main",
                borderRadius: "0px",
                p: {
                  xs: 2,
                  lg: 2,
            ...
            >
              ...
              >
                <Typography
                  variant={"headline2" as any}
                  color={color}
                >{`${unitState.format(totalInUnit)}`}</Typography>
