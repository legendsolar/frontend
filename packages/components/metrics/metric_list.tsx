...
export const MetricList = ({
  ...
  return (
    <Stack spacing={2} sx={{ width: "100%", height: "100%" }}>
      {dividerStart && <ComponentDivider sx={dividerSx}></ComponentDivider>}
        ...
        <div key={nanoid()} style={{ margin: "0px" }}>
          ...
          >
            {typeof metric === "string" ? (
              <Typography variant={"subtitle3" as any} color="blackDawn.main">
                {metric}
              </Typography>
            ) : (
              metric
            ...
            <Typography
              variant={
                value.length > 12 ? ("subtitle3" as any) : ("subtitle2" as any)
              }
              sx={{ textAlign: "right" }}
            >
              {value}
