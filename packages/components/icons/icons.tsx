...
export const DocumentIcon = ({ sx = {} }) => {
  return <BaseIcon src={DocumentSvg} alt={"Document Icon"} sx={sx}></BaseIcon>;
};
...
export const InstagramIcon = ({ sx = {} }) => {
  return (
    <BaseIcon src={InstagramIconSvg} alt={"Instagram Icon"} sx={sx}></BaseIcon>
  );
};
...
export const LinkedInIcon = ({ sx = {} }) => {
  return (
    <BaseIcon src={LinkedInIconSvg} alt={"LinkedIn Icon"} sx={sx}></BaseIcon>
  );
};
