...
export const transferToIconTypes = (transfer) => {
  ...
  if (transfer.type === "INVESTMENT") {
    return {
      ...
      right: <PanelIcon sx={{ width: "106px", height: "53px" }}></PanelIcon>,
    };
  }
...
export const TransferComponent = ({
  ...
  return (
    <Box sx={{ width: "100%", minWidth: "240px", maxWidth: "400px" }}>
      <Stack
        direction="row"
      ...
      >
        ...
        <Typography variant="subtitle2">{amountString(amount)}</Typography>
      </Stack>
      ...
      <Stack direction="row" justifyContent="space-between" sx={{ mt: 1 }}>
        ...
        <Typography variant={"label" as any}>{destinationName}</Typography>
      </Stack>
    </Box>
  );
};
