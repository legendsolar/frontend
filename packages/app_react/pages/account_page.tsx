...
import ScrollToSidebar from '../utils/scroll_to_sidebar';
import MemberHeader from '../user/member_header';
...
import AccreditationStatus from '../user/accreditation_status';
